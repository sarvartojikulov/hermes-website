  ...
  return (
    <main className="container mx-auto flex flex-col gap-20 pb-40 md:gap-20 lg:gap-36">
      ...
      >
        ...
        <div className="col-span-6 flex items-center justify-center bg-amber-200 p-10">
          <Link
            target="_blank"
        ...
        <div className="col-span-6 flex items-center justify-center bg-amber-200 p-12">
          <Link
            target="_blank"
